...
DEF_HELPER_FLAGS_5(fmul_p,    TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl)
DEF_HELPER_FLAGS_5(fdiv_p,    TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl)
DEF_HELPER_FLAGS_4(fsqrt_p,   TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(feq_p,     TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(flt_p,     TCG_CALL_NO_RWG, void, env, tl, tl, tl)
...
DEF_HELPER_FLAGS_4(fcvt_b_d, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(fcvt_b_dfpr, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(lpre, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(spre, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(lrnd, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(srnd, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(fcvt_d_b, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(fcvt_dfpr_b, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(lap, TCG_CALL_NO_RWG, i64, env, tl, tl, i64)
DEF_HELPER_FLAGS_3(sap, TCG_CALL_NO_RWG, i64, env, tl, i64)
