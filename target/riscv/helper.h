...
DEF_HELPER_FLAGS_4(fcvt_a_s, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_3(fcvt_s_a, TCG_CALL_NO_RWG, tl, env, tl, tl)
DEF_HELPER_FLAGS_4(fcvt_a_w, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_3(fcvt_w_a, TCG_CALL_NO_RWG, tl, env, tl, tl)
DEF_HELPER_FLAGS_4(fcvt_a_wu, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_3(fcvt_wu_a, TCG_CALL_NO_RWG, tl, env, tl, tl)

/* Variable Arbitrary Precision related 64-bit instructions */
DEF_HELPER_FLAGS_4(fcvt_a_d, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_3(fcvt_d_a, TCG_CALL_NO_RWG, tl, env, tl, tl)
DEF_HELPER_FLAGS_4(fcvt_a_l, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_3(fcvt_l_a, TCG_CALL_NO_RWG, tl, env, tl, tl)
DEF_HELPER_FLAGS_4(fcvt_a_lu, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_3(fcvt_lu_a, TCG_CALL_NO_RWG, tl, env, tl, tl)

DEF_HELPER_FLAGS_5(fadd_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl)
DEF_HELPER_FLAGS_5(fsub_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl)
DEF_HELPER_FLAGS_6(fmadd_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_FLAGS_6(fmsub_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_FLAGS_6(fnmadd_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_FLAGS_6(fnmsub_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl, tl)
DEF_HELPER_FLAGS_5(fmul_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl)
DEF_HELPER_FLAGS_5(fdiv_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl, tl)
DEF_HELPER_FLAGS_4(fsqrt_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_3(feq_a, TCG_CALL_NO_RWG, tl, env, tl, tl)
DEF_HELPER_FLAGS_3(flt_a, TCG_CALL_NO_RWG, tl, env, tl, tl)
DEF_HELPER_FLAGS_3(fle_a, TCG_CALL_NO_RWG, tl, env, tl, tl)
DEF_HELPER_FLAGS_4(fmin_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(fmax_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(fsgnj_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(fsgnjn_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(fsgnjx_a, TCG_CALL_NO_RWG, void, env, tl, tl, tl)
/*
 * Load and store helpers do access the global state, so they should not be
 * discarded during optimization
 */
DEF_HELPER_4(fla, i64, env, tl, tl, i64)
DEF_HELPER_3(fsa, i64, env, tl, tl)
