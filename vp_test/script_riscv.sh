...
#make e_float_double.out
#make b.out
make cholesky-asm.out
#make newton_float_double.out
#make d.out

for i in {1..10}
do
	#(time ../build/riscv64-softmmu/qemu-system-riscv64 -nographic -machine virt -bios none -kernel e_float_double.out) 2>> riscv_e_float.txt
	#(time ../build/riscv64-softmmu/qemu-system-riscv64 -nographic -machine virt -bios none -kernel e_float_double.out) 2>> riscv_e_double.txt
	...
	(time ../build/riscv64-softmmu/qemu-system-riscv64 -nographic -machine virt -bios none -kernel cholesky-asm.out) 2>> riscv_cholesky_float.txt
	...
	#(time ../build/riscv64-softmmu/qemu-system-riscv64 -nographic -machine virt -bios none -kernel newton_float_double.out) 2>> riscv_newton_float.txt
	#(time ../build/riscv64-softmmu/qemu-system-riscv64 -nographic -machine virt -bios none -kernel newton_float_double.out) 2>> riscv_newton_double.txt
